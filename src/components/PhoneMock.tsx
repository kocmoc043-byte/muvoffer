...
const PhoneMock = ({ src, alt, caption, rotate = "0deg" }: PhoneMockProps) => {
  return (
    <div className="flex flex-col items-center gap-3" style={{ transform: `rotate(${rotate})` }}>
      <div className="relative w-[200px] h-[420px] rounded-[2.5rem] bg-surface-elevated p-2 shadow-[var(--shadow-card)] ring-1 ring-brand/20">
